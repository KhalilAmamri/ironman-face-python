# imortaing the turtle module to draw shapes
import turtle
# setting the turtle speed to 0
face_one = [
...
# hiding the turtle and setting the background color to red
turtle.hideturtle()
turtle.bgcolor("red")
...
turtle.speed(4)
# Function to draw a face given the segments and starting position
